...
"""
x = int(input("Dati un nr de tastatura x: "))
y = int(input("Dati un nr de tastatura y: "))
diff = x - y
rest_impart = x % y
mult = x * y
power3 = x ** 3
print(f"Diferenta = {diff}, Restul impartirii = {rest_impart}, Inmultirea = {mult}, x la puterea 3 = {power3}")